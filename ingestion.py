...
DATA_FILE = os.path.join(BASE_DIR, "data", "readytensor_awards.json")
...
def extract_awards(desc: str):
    """Extract awards/tags from publication_description text."""
    awards = []
...
def ingest():
    ...
    for pub in publications:
        ...
        awards = extract_awards(desc)

        # Always store awards as a safe string
    ...
    # ✅ Safe batching instead of one big call
